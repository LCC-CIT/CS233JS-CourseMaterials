...
keywords: Announcements, Due Dates, Term Project, Help
generator: Typora
author: Brian Bird
...
<h1>Week 9 Overview for Winter 2026</h1>

<h2>March 2 through March 8</h2>
...
- Program elective options: 
  ...
  - CS 233P or C: Intermediate Programming: Python (recommended) or C_++ (prerequisite: CS 133P or C)
...
- Do you have any questions about lab 7 (the event app) or the term project?
...
| ------------------------- | ------------------------------------------------------------ | -------------------------------------------- |
| **8<br />2/24&ndash;3/2** | Step 1: [Description + UI Sketch](../Labs/TermProject/CS233JS_ProjectInstructions.html#proposal-description--ui-mockup) | Tuesday, Feb. 25\3                           |
| **9<br />3/3&ndash;3/9**  | <mark>Step 2: [API Call Research + Documentation](../Labs/TermProject/CS233JS_ProjectInstructions.html#api-call-research--documentation)</mark> | Tuesday, March 3                             |
|                           | <mark>Step 3: [JavaScript Dev Environment + Static HTML & CSS](../Labs/TermProject/CS233JS_ProjectInstructions.html#dev-environment--html--css)</mark> | Thursday, March 5                            |
|                           | <mark>Step 4: [Implementation](../Labs/TermProject/CS233JS_ProjectInstructions.html#production-version)<br />Beta Version</mark> | Sunday, March 8                              |
| **10<br />3/10&ndash;16** | Code Review                                                  | Tuesday, March 10                            |
|                           | Production Version                                           | Thursday, March 12<br />Cut-off, Sunday 3/15 |

## Help Links

- Drop-in office hours on [Zoom](https://lanecc.zoom.us/j/8982554800) and in person M, W 1:00&ndash;1:50; Tu,Th, 2:00 to 2:50,  
  or DM @profbird on Discord, or email birdb@lanecc.edu to meet at another time.
...
- Class Discord discussion channel 
