---
title: Lab 2 ES6 Features
description: Practice with key ES6 features
keywords: destructuring, spread operator, arrow functions, default parameters, template literals
